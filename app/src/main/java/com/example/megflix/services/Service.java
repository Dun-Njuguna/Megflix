package com.example.megflix.services;

import android.util.Log;

import com.example.megflix.Constants;
        ...
        try {
            ...
            if (response.isSuccessful()) {
                for (int i = 0; i < resultsJSON.length(); i++) {
                    ...
                    String network = resultJSON.getString("network");

                    Popular popular =  new Popular(name,image_thumbnail_path,start_date,status,network);
